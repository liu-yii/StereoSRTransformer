...
Method = 'stereoinr_refine_h8';                      % Method for evaluation
...
Datasets = {'Flickr1024'};
GT_folder = 'E:/Research/Datasets/iPASSR/test/';
...
for DatasetIndex = 1 : dataset_num
    ...
    for iScene = 1 : sceneNum
        ...
        sr_left = imread([ResultsPath, scene_name, '_l.png']);
        sr_right = imread([ResultsPath, scene_name, '_r.png']);
...
if (ch == 1)
    ...
    for i = 1:ch
        ssim = ssim + ssim_index(im1(:, :, i), im2(:, :, i));
    end
    ssim = ssim/3;
end
end
